...
public class LifterHardware {
    ...
    public LifterHardware(DcMotor leftLiftMotor, DcMotor rightLiftMotor, Servo leftTurnServo, Servo rightTurnServo, CRServo leftGrabServo, CRServo rightGrabServo) {
